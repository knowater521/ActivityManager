...
class Reg_with_team(Form):
    user = StringField('组长姓名', [validators.required()], description="你的姓名")
    pwd = StringField('组长学号', [validators.required()], description="你的学号")
